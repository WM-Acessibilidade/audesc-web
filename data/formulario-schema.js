(function(){
  ...
  const campos=[
    ...
    {codigo:'categoria_evento',nome:'Categoria do evento',grupo:'identificacao',tipo:'select',configuravel:true,boxId:'categoriaEventoBox'},
    {codigo:'classificacao_etaria',nome:'Classificação etária',grupo:'identificacao',tipo:'select',configuravel:true,boxId:'classificacaoEtariaBox'},
    {codigo:'modalidade_evento',nome:'Modalidade do evento',grupo:'localizacao',tipo:'select',configuravel:true,boxId:'modalidadeEventoBox'},
