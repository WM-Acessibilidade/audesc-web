...
(function(){
  const paisesBase = [
    ...
    { nome:'Angola', codigo:'AO', rotulo:'Província', padrao:'Luanda', unidades:['Bengo','Benguela','Bié','Cabinda','Cuando Cubango','Cuanza Norte','Cuanza Sul','Cunene','Huambo','Huíla','Luanda','Lunda Norte','Lunda Sul','Malanje','Moxico','Namibe','Uíge','Zaire'], codigos:{'Luanda':'LUA','Cabinda':'CAB'} },
    { nome:'Cabo Verde', codigo:'CV', rotulo:'Ilha', padrao:'Santiago', unidades:['Boa Vista','Brava','Fogo','Maio','Sal','Santiago','Santo Antão','São Nicolau','São Vicente'], codigos:{'Santiago':'ST','São Vicente':'SV','Sal':'SL'} },
    { nome:'Guiné-Bissau', codigo:'GW', rotulo:'Região', padrao:'Setor Autônomo de Bissau', unidades:['Bafatá','Biombo','Bolama/Bijagós','Cacheu','Gabú','Oio','Quinara','Tombali','Setor Autônomo de Bissau'], codigos:{'Setor Autônomo de Bissau':'BS'} },
    { nome:'Guiné Equatorial', codigo:'GQ', rotulo:'Província', padrao:'Bioko Norte', unidades:['Annobón','Bioko Norte','Bioko Sul','Centro Sul','Djibloho','Kie-Ntem','Litoral','Wele-Nzas'], codigos:{'Bioko Norte':'BN','Bioko Sul':'BS','Litoral':'LI'} },
    { nome:'Moçambique', codigo:'MZ', rotulo:'Província', padrao:'Maputo Cidade', unidades:['Cabo Delgado','Gaza','Inhambane','Manica','Maputo','Maputo Cidade','Nampula','Niassa','Sofala','Tete','Zambézia'], codigos:{'Maputo Cidade':'MPM','Maputo':'MAP'} },
    { nome:'Portugal', codigo:'PT', rotulo:'Distrito ou região autônoma', padrao:'Lisboa', unidades:['Aveiro','Beja','Braga','Bragança','Castelo Branco','Coimbra','Évora','Faro','Guarda','Leiria','Lisboa','Portalegre','Porto','Santarém','Setúbal','Viana do Castelo','Vila Real','Viseu','Açores','Madeira'], codigos:{'Lisboa':'LIS','Porto':'POR','Açores':'ACO','Madeira':'MAD'} },
    { nome:'São Tomé e Príncipe', codigo:'ST', rotulo:'Distrito ou região autônoma', padrao:'Água Grande', unidades:['Água Grande','Cantagalo','Caué','Lembá','Lobata','Mé-Zóchi','Região Autônoma do Príncipe'], codigos:{'Água Grande':'AG','Região Autônoma do Príncipe':'PR'} },
    { nome:'Timor-Leste', codigo:'TL', rotulo:'Município ou região administrativa especial', padrao:'Díli', unidades:['Aileu','Ainaro','Ataúro','Baucau','Bobonaro','Covalima','Díli','Ermera','Lautém','Liquiçá','Manatuto','Manufahi','Oecusse','Viqueque'], codigos:{'Díli':'DI','Baucau':'BA','Oecusse':'OE'} },
